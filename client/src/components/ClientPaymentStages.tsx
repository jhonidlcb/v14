              ...
              <div className="flex-1">
                ...
                <div className="bg-white p-4 rounded-lg border mb-4 
                  ...
                  <h4 className={`font-semibold mb-2 ${
                      nextPayment.status === 'available' ? 'text-green-800 border-green-200' :
                      nextPayment.status === 'pending_verification' ? 'text-yellow-800 border-yellow-200' :
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-4 flex-1">
                      <div className="flex-shrink-0">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
                          ...
                          {stage.status === 'paid' ? '✓' : stage.status === 'pending_verification' ? <Clock size={14} /> : index + 1}
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {stage.status === 'pending_verification' && (
                        <div className="text-xs text-center text-yellow-700 bg-yellow-50 p-2 rounded border border-yellow-200">
                          <Clock className="h-3 w-3 mx-auto mb-1" />
                          Verificando<br />comprobante
                        </div>
                      )}
